...
r6 = '1928.12.10 1999/14/01 2005:05:01 2005:05:29 2005:05:31 2005:05:30 2000-01-01 2000-01-32 1950-06-39'
res = re.findall(r'[12][0-9][0-9][0-9][./:-][0-1][0-9][./:-][0-3][0-9]', r6)
print(res)

res = re.findall(r'[0-2][0-9][0-9][0-9][./:-][0-9][0-9][./:-][0-2,0-9][3,0-1]', r6)
print(res)


r7 = 'grey gr7y gro green'
res = re.findall(r'gr[e|0-9]y', r7)
print(res)
